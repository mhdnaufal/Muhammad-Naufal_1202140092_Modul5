...
public class Adapter extends RecyclerView.Adapter<Adapter.holder> {
    ...
    //konstruktor
    public Adapter(Context konteks, ArrayList<AddDataActivity> list, int color){
    ...
    public holder onCreateViewHolder(ViewGroup parent, int viewType) {
        //membuat view baru
        View view = LayoutInflater.from(konteks).inflate(R.layout.cardview_list, parent, false);
    ...
    public void onBindViewHolder(holder holder, int position) {
        ...
        holder.cardv.setCardBackgroundColor(konteks.getResources().getColor(this.color));
    }
